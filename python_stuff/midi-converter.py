...
# Written by Max Xiang for the N76E003 DDS music player program
...
output_str += "48, 48, 48, 48, 48, 48, 48, 48, 48, 48\n\n; Note: this file was generated by the included Python " \
              "program. (Also written by Max Xiang)\n "

with open(text_output_path, 'w') as f:
    f.write(output_str)

output_str += "\n// Data size: " + str(int(output_length / 100) / 10) + "kb (approx)\n"
print(output_str)
